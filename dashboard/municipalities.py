"""Official Danish municipality codes (Danmarks Statistik / LAU) -> names.

The source dataset only carries the numeric code; this mapping is static
public reference data (98 municipalities, unchanged since the 2007 reform).
"""
...
MUNICIPALITY_NAMES = {
    ...
    746: "Skanderborg", 751: "Aarhus", 756: "Ikast-Brande",
...
def municipality_name(code: int) -> str:
    return MUNICIPALITY_NAMES.get(code, str(code))
